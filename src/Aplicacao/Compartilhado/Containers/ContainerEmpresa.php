...
return [
	...
	ImplementacaoLidarCadastrarEmpresa::class => function(Container $container)
	{
		return new ImplementacaoLidarCadastrarEmpresa(
		    repositorioAutenticacaoComando: $container->get(RepositorioAutenticacao::class),
            mensageria: $container->get(Mensageria::class),
            discord: $container->get(Discord::class),
		);
	},
    RepositorioEmpresa::class => function(Container $container)
    {
