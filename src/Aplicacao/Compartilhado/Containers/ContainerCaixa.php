...
use App\Infraestrutura\Repositorios\Financeiro\Caixa\ImplementacaoRepositorioCaixa;
use PDO;
use Exception;
use DI\Container;
...
return [
    RepositorioCaixa::class => function(Container $container)
    {
        return new ImplementacaoRepositorioCaixa(
